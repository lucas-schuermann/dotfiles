...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = coc_nvim_1.workspace.getConfiguration(EXTENSION_ID);
        const debug = config.get('debug');
        const filetypes = config.get('filetypes');
        const watcherPattern = config.get('watcherPattern');
        ...
        let clientOptions = {
            ...
            synchronize: {
                fileEvents: coc_nvim_1.workspace.createFileSystemWatcher(watcherPattern),
            },
            outputChannel: coc_nvim_1.workspace.createOutputChannel(EXTENSION_ID),
            outputChannelName: EXTENSION_ID,
        };
        let client = new coc_nvim_1.LanguageClient(EXTENSION_ID, serverOptions, clientOptions, debug);
