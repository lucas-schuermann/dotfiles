...
async function getGraphQLCache(configDir, parser, extensions, config) {
    let graphQLConfig = config !== null && config !== void 0 ? config : (await graphql_config_1.loadConfig({ rootDir: configDir }));
