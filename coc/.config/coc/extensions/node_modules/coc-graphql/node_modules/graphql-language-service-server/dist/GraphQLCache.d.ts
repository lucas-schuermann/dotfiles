...
export declare function getGraphQLCache(configDir: Uri, parser: typeof parseDocument, extensions?: Array<(config: GraphQLConfig) => GraphQLConfig>, config?: GraphQLConfig): Promise<GraphQLCacheInterface>;
export declare class GraphQLCache implements GraphQLCacheInterface {
    ...
    _readFilesFromInputDirs: (rootDir: string, includes: string[]) => Promise<Array<GraphQLFileMetadata>>;
