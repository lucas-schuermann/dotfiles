...
function findGraphQLTags(text, ext) {
    const result = [];
                        ...
                        fragments.properties.forEach((property) => {
                            if ('value' in property &&
                                ...
                                if (tagName && property.value.loc) {
                                    ...
                                    const range = new graphql_language_service_utils_1.Range(new graphql_language_service_utils_1.Position(loc.start.line - 1, loc.start.column), new graphql_language_service_utils_1.Position(loc.end.line - 1, loc.end.column));
                                    result.push({
                                        tag: tagName,
                                        template,
                                        range,
